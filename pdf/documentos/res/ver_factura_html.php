...
<page backtop="15mm" backbottom="15mm" backleft="15mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
       ...
       <br>
		...
		<tr>
		  ...
		  <td style="width:25%;"><?php echo date("d/m/Y", strtotime($fecha_factura));?></td>
		   <td style="width:40%;" >
				<?php 
				if ($condiciones==1){echo "Dinheiro";}
				elseif ($condiciones==2){echo "Cheque";}
				elseif ($condiciones==3){echo "Transferência bancaria";}
    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 10pt;">
        <tr>
            <th style="text-align:left" class='midnight-blue'>Quant.</th>
            <th style="text-align:left" class='midnight-blue'>Descrição</th>
            <th style="text-align: right" class='midnight-blue'>Preço Unit.</th>
            <th style="text-align: right" class='midnight-blue'>Preço Total</th>
...
?>
	...
	<br>
	<div style="font-size:11pt;text-align:center;font-weight:bold">Obrigado pela sua compra!</div>
