<?php
	...
	if (empty($_POST['id_cliente'])) {
		...
		$query_update = mysqli_query($con,$sql);
			if ($query_update){
				$messages[] = "Fatura atualizada com sucesso.";
			} else{
				$errors []= "Erro ao atualizar fatura por favor tente mais tarde.".mysqli_error($con);
			}
		} else {
