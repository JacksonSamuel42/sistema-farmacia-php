	...
	if (isset($_GET['id'])){
		...
		if ($count==0){
			...
			<div class="alert alert-danger alert-dismissible" role="alert">
			  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
			  <strong>Error!</strong>Desculpe, algo deu errado, tente novamente.
			</div>
			<?php
			...
			<div class="alert alert-danger alert-dismissible" role="alert">
			  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
			  <strong>Error!</strong> Não foi possível excluir este cliente. Existem faturas vinculadas a este produto. 
			</div>
			<?php
		}
			...
			<div class="table-responsive">
			  <table class="table">
				...
				while ($row=mysqli_fetch_array($query)){
						...
						if ($status_cliente==1){$estado="Ativo";}
						else {$estado="Inativo";}
