	...
	if (isset($_GET['id'])){
		...
		if ($count==0){
			...
			<div class="alert alert-danger alert-dismissible" role="alert">
			  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
			  <strong>Error!</strong> algo ocorreu mau tente contactar o suporte.
			</div>
			<?php
			...
			<div class="alert alert-danger alert-dismissible" role="alert">
			  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
			  <strong>Error!</strong> Este produto não pôde ser removido. Existem citações ligadas a este produto. 
			</div>
			<?php
		}
			...
			<div class="table-responsive">
			  <table class="table">
				...
				while ($row=mysqli_fetch_array($query)){
						...
						if ($status_producto==1){$estado="Ativo";}
						else {$estado="Inativo";}
