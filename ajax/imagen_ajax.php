	<?php
				...
				$errors[]= "<p>Apenas arquivos no formato JPG , JPEG, PNG e GIF são permitidos.</p>";
				} else if ($imageFileZise > 1048576) {//1048576 byte=1MB
				$errors[]= "<p>Arquivo demasiado grande selecione um logo com menos de de 1MB</p>";
				}  else
			{
				...
				if ($imageFileZise>0){
                    ...
                    if ($query_new_insert) {
                        ...
                        $errors[] = "Atualização falhou tente novamente mais tarde. ".mysqli_error($con);
                    }
			}
		}	
