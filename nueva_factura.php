<?php
	...
	$active_clientes="";
	$active_usuarios="";	
	$title="Nova Fatura | SIG-Farmácia";
  ...
  <body>
	...
	<div class="panel panel-info">
		<div class="panel-heading">
			<h4><i class='fa fa-edit'></i> Nova Fatura</h4>
		</div>
		...
		?>
			<form class="form-horizontal" role="form" id="datos_factura">
				<div class="form-group row">
				  ...
				  <div class="col-md-3">
					  <input type="text" class="form-control input-sm" id="nombre_cliente" placeholder="Seleciona um cliente" required>
