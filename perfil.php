<?php
	...
	$title="Configuração | SIG'Farmacia";
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 toppad" >
          ...
          <div class="panel panel-info">
            <div class="panel-heading">
              <h3 class="panel-title"><i class='fa fa-cog'></i> Configuração</h3>
            </div>
