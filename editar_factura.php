<?php
	...
	$active_clientes="";
	$active_usuarios="";	
	$title="Editar Fatura | SIG-Farmácia";
	...
	<div class="container">
		<div class="panel panel-info">
			<div class="panel-heading">
				<h4><i class='fa fa-edit'></i> Editar Fatura</h4>
			</div>
					...
					<div class="form-group row">
						...
						<div class="col-md-3">
							<input type="text" class="form-control input-sm" id="nombre_cliente"
								placeholder="Seleciona um cliente" required value="<?php echo $nombre_cliente;?>">
							<input id="id_cliente" name="id_cliente" type='hidden' value="<?php echo $id_cliente;?>">
						</div>
						<label for="tel1" class="col-md-1 control-label">Telefone</label>
						<div class="col-md-2">
							<input type="text" class="form-control input-sm" id="tel1" placeholder="telefone"
					...
					<div class="form-group row">
						...
						<div class="col-md-2">
							<input type="text" class="form-control input-sm" id="fecha"
								value="<?php echo $fecha_factura;?>" readonly>
						</div>
						<label for="email" class="col-md-1 control-label">Pago</label>
						<div class="col-md-2">
							<select class='form-control input-sm ' id="condiciones" name="condiciones">
								<option value="1" <?php if ($condiciones==1){echo "selected";}?>>Dinheiro</option>
								<option value="2" <?php if ($condiciones==2){echo "selected";}?>>Cheque</option>
								<option value="3" <?php if ($condiciones==3){echo "selected";}?>>Transferência bancaria
								</option>
					...
					<div class="col-md-12">
						<div class="pull-right">
							...
							<button type="button" class="btn btn-default" data-toggle="modal"
								...
								<span class="fa fa-user"></span> Novo cliente
							</button>
							<button type="button" class="btn btn-default" data-toggle="modal" data-target="#myModal">
								<span class="fa fa-search"></span> Agregar produtos
							</button>
